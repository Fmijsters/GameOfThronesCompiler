...
public class Compiler {
    ...
    private void compile(CharStream input, String jasminFileName, String classFileName)
        ...
        if (!runChecker(parseTree,currentScope))
            return;

        // Phase 4: Generate code
        String jasminCode = generateCode(parseTree,currentScope);
     ...
     */
    private boolean runChecker(ParseTree parseTree, Scope scope) {
        ...
        TypeChecker typeChecker = new TypeChecker(scope);
     ...
     */
    private String generateCode(ParseTree parseTree, Scope scope) {
...
//        // Main method
        ...
        out.println(".limit locals 98");  // NOTE: The args-parameter is a local too

        GameOfThronesVisitor visitor = new GameOfThronesVisitor(out,scope);
